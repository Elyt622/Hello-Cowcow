...
import com.example.hellocowcow.domain.recovery.CowCowFinalClaimPreviewCodec

object CowCowFinalClaimTransactionFactory {
  ...
  fun create(
    ...
    val encoded = CowCowFinalClaimPreviewCodec.encode(cowNonces)
    ...
    return MvxTransaction(
      ...
      gasLimit = CowCowConfig.FINAL_CLAIM_GAS_LIMIT +
